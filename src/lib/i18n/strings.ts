...
const STRINGS = {
  ...
  navEdd: { en: "Enhanced Due Diligence", fr: "Vigilance renforcée" },
  navSarStr: { en: "SAR/STR Filing", fr: "Déclaration SAR/STR" },
  navCtr: { en: "Cash transaction reports", fr: "Rapports de transactions en espèces" },
  ctrPageTitle: { en: "Cash transaction reports", fr: "Rapports de transactions en espèces" },
  ctrPageSubtitle: { en: "Generate threshold reports and manage MLRO filing controls.", fr: "Générez les rapports de seuil et gérez les contrôles de dépôt MLRO." },
  ctrPeriodStart: { en: "Period start", fr: "Début de la période" },
  ctrPeriodEnd: { en: "Period end", fr: "Fin de la période" },
  ctrCurrency: { en: "Currency", fr: "Devise" },
  ctrCurrencyPlaceholder: { en: "e.g. XOF", fr: "ex. XOF" },
  ctrThreshold: { en: "Threshold", fr: "Seuil" },
  ctrThresholdPlaceholder: { en: "e.g. 5000000", fr: "ex. 5000000" },
  ctrGenerate: { en: "Generate reports", fr: "Générer les rapports" },
  ctrEmpty: { en: "No cash transaction reports found.", fr: "Aucun rapport de transactions en espèces." },
  ctrCustomer: { en: "Customer", fr: "Client" },
  ctrPeriod: { en: "Period", fr: "Période" },
  ctrAmount: { en: "Cash total", fr: "Total espèces" },
  ctrCount: { en: "Transactions", fr: "Transactions" },
  ctrStatus: { en: "Status", fr: "Statut" },
  ctrReference: { en: "Reference", fr: "Référence" },
  ctrActions: { en: "Actions", fr: "Actions" },
  ctrReview: { en: "Review", fr: "Examiner" },
  ctrApprove: { en: "Approve", fr: "Approuver" },
  ctrFile: { en: "Record filed", fr: "Enregistrer le dépôt" },
  ctrGenerated: { en: "CTR reports generated.", fr: "Rapports CTR générés." },
  ctrUpdated: { en: "CTR updated.", fr: "CTR mis à jour." },
  ctrStatus_draft: { en: "Draft", fr: "Brouillon" },
  ctrStatus_mlro_review: { en: "MLRO review", fr: "Examen MLRO" },
  ctrStatus_filing_pending: { en: "Filing pending", fr: "Dépôt en attente" },
  ctrStatus_filed: { en: "Filed", fr: "Déposé" },
  ctrStatus_rejected: { en: "Rejected", fr: "Rejeté" },

  eddPageTitle: { en: "Enhanced due diligence", fr: "Vigilance renforcée" },
  eddPageSubtitle: { en: "Review high-risk customer cases and record your decision.", fr: "Examinez les dossiers clients à haut risque et enregistrez votre décision." },
  eddCustomer: { en: "Customer", fr: "Client" },
  eddTrigger: { en: "Trigger", fr: "Déclencheur" },
  eddDetails: { en: "Review details", fr: "Détails de l'examen" },
  eddStatus: { en: "Status", fr: "Statut" },
  ...
  eddNotesPlaceholder: {
    en: "e.g. Source of funds confirmed via payslips; awaiting proof of address dated within 3 months.",
    fr: "ex. Source des fonds confirmée via des bulletins de salaire ; justificatif de domicile de moins de 3 mois en attente.",
  },
  ...
  eddChecklist_sourceOfFundsReviewed: { en: "Source of funds reviewed", fr: "Source des fonds examinée" },
  eddChecklist_sourceOfWealthReviewed: { en: "Source of wealth reviewed", fr: "Source du patrimoine examinée" },
  eddChecklist_businessPurposeVerified: { en: "Business purpose verified", fr: "Objet de l'activité vérifié" },
  eddChecklist_seniorApproval: { en: "Senior approval", fr: "Approbation de la direction" },
  eddEmpty: { en: "No enhanced due diligence reviews found.", fr: "Aucun examen de vigilance renforcée trouvé." },
  eddStatus_pending: { en: "Pending", fr: "En attente" },
  eddStatus_in_review: { en: "In review", fr: "En cours d'examen" },
  eddStatus_approved: { en: "Approved", fr: "Approuvé" },
  eddStatus_rejected: { en: "Rejected", fr: "Rejeté" },
  eddTrigger_pep_confirmed: { en: "Confirmed PEP", fr: "PPE confirmée" },
  eddTrigger_sanctions_match: { en: "Sanctions match", fr: "Correspondance sanctions" },
  eddTrigger_high_risk_score: { en: "High risk score", fr: "Score de risque élevé" },
  eddTrigger_repeated_alerts: { en: "Repeated alerts", fr: "Alertes répétées" },

  // ── PEP control ──────────────────────────────────────────────────────────
  pepPageTitle: { en: "PEP control", fr: "Contrôle PPE" },
  pepPageSubtitle: { en: "Record and review politically exposed person designations for your customers.", fr: "Enregistrez et examinez les désignations de personnes politiquement exposées pour vos clients." },
  pepCreateTitle: { en: "Create designation", fr: "Créer une désignation" },
  pepCustomerId: { en: "Customer ID", fr: "Identifiant client" },
  pepCustomerIdPlaceholder: { en: "e.g. CUST-00456", fr: "ex. CUST-00456" },
  pepStatus: { en: "Status", fr: "Statut" },
  pepCategory: { en: "Category", fr: "Catégorie" },
  pepRole: { en: "Role", fr: "Fonction" },
  pepRolePlaceholder: { en: "e.g. Minister of Finance", fr: "ex. Ministre des Finances" },
  pepJurisdiction: { en: "Jurisdiction", fr: "Juridiction" },
  pepJurisdictionPlaceholder: { en: "e.g. Senegal", fr: "ex. Sénégal" },
  pepSource: { en: "Source", fr: "Source" },
  pepSourcePlaceholder: { en: "e.g. OpenSanctions PEP list", fr: "ex. Liste PPE OpenSanctions" },
  pepNotes: { en: "Notes", fr: "Notes" },
  pepNotesPlaceholder: {
    en: "e.g. Confirmed as a former deputy after manual verification of the electoral register.",
    fr: "ex. Confirmé comme ancien député après vérification manuelle du registre électoral.",
  },
  pepCreateButton: { en: "Create designation", fr: "Créer la désignation" },
  pepListTitle: { en: "Your designations", fr: "Vos désignations" },
  ...
  pepStatus_false_positive: { en: "False positive", fr: "Faux positif" },
  pepStatus_cleared: { en: "Cleared", fr: "Écartée" },
  pepStatus_expired: { en: "Expired", fr: "Expirée" },
  pepCategory_domestic: { en: "Domestic", fr: "Nationale" },
  pepCategory_foreign: { en: "Foreign", fr: "Étrangère" },
  pepCategory_international_organisation: { en: "International organisation", fr: "Organisation internationale" },
  pepCategory_family_member: { en: "Family member", fr: "Membre de la famille" },
  pepCategory_close_associate: { en: "Close associate", fr: "Associé proche" },
  ...
  navAlertRules: { en: "Pan Studio", fr: "Pan Studio" },
  ...
  ruleDomainIdentity: { en: "Identity — checked at KYC", fr: "Identité — vérifiée au KYC" },
  ...
  clientsColCountry: { en: "Country", fr: "Pays" },
  clientsColActivatedDate: { en: "Activated", fr: "Activée" },
  clientsColRejectedDate: { en: "Rejected", fr: "Rejetée" },
  clientsEmptyInvited: {
  ...
  clientsComplianceProviderLabel: { en: "Screening provider", fr: "Fournisseur de filtrage" },
  clientsComplianceFallbackWarning: { en: "Warning: fallback screening was used.", fr: "Attention : le filtrage de secours a été utilisé." },
  ...
  sanctionsSearchCustomerIdLabel: { en: "Customer ID (optional)", fr: "ID client (facultatif)" },
  sanctionsSearchCustomerIdPlaceholder: { en: "External customer ID", fr: "ID client externe" },
  sanctionsSearchCustomerIdHintTied: {
    en: "A qualifying hit will be tied to this customer record and can be reviewed later from their risk profile.",
    fr: "Une correspondance sera rattachée à ce dossier client et pourra être examinée plus tard depuis son profil de risque.",
  },
  sanctionsSearchCustomerIdHintTransient: {
    en: "No customer ID entered — this lookup is transient and nothing will be saved.",
    fr: "Aucun ID client saisi — cette recherche est transitoire et rien ne sera enregistré.",
  },
  ...
  teamColJoined: { en: "Joined", fr: "Inscription" },
  teamColExpires: { en: "Expires", fr: "Expiration" },
  ...
  docSubmittedDate: { en: "Submitted", fr: "Soumis" },
  docReviewedDate: { en: "Reviewed", fr: "Examiné" },
  ...
  alertsVerdictStepUp: { en: "Step-up", fr: "Vérification renforcée" },
  alertsVerdictEscalate: { en: "Escalate", fr: "Escalade" },
  alertsVerdictAlert: { en: "Alert", fr: "Alerte" },
  ruleDialogSeverityTitle: { en: "When this rule fires", fr: "Quand cette règle se déclenche" },
  ruleDialogSeverityHint: {
    en: "How serious a hit is — \"Escalate\" opens an investigation case automatically, the others just raise an alert to review.",
    fr: "La gravité d'une correspondance — « Escalade » ouvre automatiquement un dossier d'enquête, les autres se contentent de lever une alerte à vérifier.",
  },
  ...
  alertsAssignedTo: { en: "Assigned to", fr: "Assignée à" },
  alertsUnassigned: { en: "Unassigned", fr: "Non assignée" },
  alertsDisposition: { en: "Disposition", fr: "Qualification" },
  alertsNoDisposition: { en: "No disposition", fr: "Aucune qualification" },
  alertsDispositionConfirmedFraud: { en: "Confirmed fraud", fr: "Fraude confirmée" },
  alertsDispositionFalsePositive: { en: "False positive", fr: "Faux positif" },
  alertsDispositionNoAction: { en: "No action", fr: "Aucune action" },
  alertsDispositionSarFiled: { en: "SAR filed", fr: "SAR déposée" },
  alertsDispositionEscalated: { en: "Escalated", fr: "Escaladée" },
  alertsInvestigationNotes: { en: "Investigation notes", fr: "Notes d'enquête" },
  alertsInvestigationNotesPlaceholder: {
    en: "e.g. Contacted customer Aminata Diallo — confirmed she did not initiate this transfer.",
    fr: "ex. Client Aminata Diallo contactée — a confirmé ne pas être à l'origine de ce transfert.",
  },
  alertsDueAt: { en: "Due", fr: "Échéance" },
  alertsResolvedAt: { en: "Resolved", fr: "Résolue" },
  alertsEditLifecycle: { en: "Edit investigation details", fr: "Modifier les détails de l'enquête" },
  alertsSaveLifecycle: { en: "Save details", fr: "Enregistrer les détails" },
  ...
  deviceSignalsColDevice: { en: "Device", fr: "Appareil" },
  deviceSignalsColCountry: { en: "Country", fr: "Pays" },
  deviceSignalsNoEnrichedData: { en: "No enriched data", fr: "Pas de données enrichies" },
  deviceAttrRooted: { en: "Rooted/Jailbroken", fr: "Rooté/Jailbreaké" },
  deviceAttrEmulator: { en: "Emulator", fr: "Émulateur" },
  deviceAttrVpnActive: { en: "VPN active", fr: "VPN actif" },
  deviceAttrCharging: { en: "Charging", fr: "En charge" },
  deviceAttrConnectionType: { en: "Connection", fr: "Connexion" },
  deviceAttrBatteryLevel: { en: "Battery", fr: "Batterie" },
  deviceAttrTimezone: { en: "Time zone", fr: "Fuseau horaire" },
  deviceAttrLanguage: { en: "Language", fr: "Langue" },
  deviceAttrAppVersion: { en: "App version", fr: "Version de l'app" },
  deviceAttrScreen: { en: "Screen", fr: "Écran" },
  deviceAttrRawTitle: { en: "Raw device attributes", fr: "Attributs bruts de l'appareil" },
  deviceAttrIpHashLabel: {
    en: "Network fingerprint (not an IP address)",
    fr: "Empreinte réseau (pas une adresse IP)",
  },
  deviceAttrIpLabel: { en: "IP address", fr: "Adresse IP" },
  deviceAttrPhoneNumber: { en: "Phone number", fr: "Numéro de téléphone" },
  deviceSignalsColIp: { en: "IP address", fr: "Adresse IP" },
  deviceSignalsColPhone: { en: "Phone number", fr: "Numéro de téléphone" },
  deviceSignalsColConnection: { en: "Connection", fr: "Connexion" },
  deviceSignalsColBattery: { en: "Battery", fr: "Batterie" },
  deviceSignalsColFlags: { en: "Flags", fr: "Indicateurs" },
  deviceSignalDetailSectionTitle: { en: "Device signal", fr: "Signal appareil" },
  ...
  behavioralColId: { en: "Signal ID", fr: "ID du signal" },
  deviceSignalsColEventId: { en: "Event ID", fr: "ID de l'événement" },
  ...
  riskProfileScoreWeightedHint: {
    en: "Composite score weighted by fusion importance (Behavioral 35%, Network 40%, Contextual 15%, Historical 10%) — the most informative single number.",
    fr: "Score composite pondéré par l'importance de fusion (Comportemental 35 %, Réseau 40 %, Contextuel 15 %, Historique 10 %) — le chiffre le plus informatif à lui seul.",
  },
  ...
  riskProfileCategoryContextual: { en: "Contextual", fr: "Contextuel" },
  riskProfileCategoryHistorical: { en: "Historical", fr: "Historique" },
  ...
  riskProfileHistoryTitle: { en: "Score history", fr: "Historique du score" },
  riskProfileHistoryEmpty: { en: "No score changes recorded yet.", fr: "Aucune évolution de score enregistrée pour l'instant." },

  // ── Durable screening matches (sanctions/PEP, per customer) ─────────────
  screeningMatchesTitle: { en: "Screening matches", fr: "Correspondances de filtrage" },
  screeningMatchesEmpty: { en: "No sanctions/PEP matches on record for this customer.", fr: "Aucune correspondance sanctions/PPE enregistrée pour ce client." },
  screeningMatchStatusPossible: { en: "Possible match", fr: "Correspondance possible" },
  screeningMatchStatusConfirmed: { en: "Confirmed", fr: "Confirmée" },
  screeningMatchStatusFalsePositive: { en: "False positive", fr: "Faux positif" },
  screeningMatchStatusCleared: { en: "Cleared", fr: "Levée" },
  screeningMatchScoreLabel: { en: "score", fr: "score" },
  screeningMatchMatchedOnLabel: { en: "matched on", fr: "correspondance sur" },
  screeningMatchVerifiedAtLabel: { en: "verified", fr: "vérifiée le" },
  ...
  casesColAssignee: { en: "Assignee", fr: "Assigné à" },
  casesColAlerts: { en: "Alerts", fr: "Alertes" },
  casesColOutcome: { en: "Outcome", fr: "Résultat" },
  casesColUpdated: { en: "Updated", fr: "Mis à jour" },
  casesColClosed: { en: "Closed", fr: "Clôturé" },
  casesColPriority: { en: "Priority", fr: "Priorité" },
  casesColActions: { en: "Actions", fr: "Actions" },
  casePriorityCritical: { en: "Critical", fr: "Critique" },
  casePriorityHigh: { en: "High", fr: "Élevée" },
  casePriorityMedium: { en: "Medium", fr: "Moyenne" },
  casePriorityLow: { en: "Low", fr: "Faible" },
  caseNoteVisibilityLabel: { en: "Visibility", fr: "Visibilité" },
  caseNoteVisibilityInternal: { en: "Internal", fr: "Interne" },
  caseNoteVisibilityPartnerVisible: { en: "Partner-visible", fr: "Visible du partenaire" },
  caseEvidenceTitle: { en: "Evidence", fr: "Preuves" },
  caseEvidenceEmpty: { en: "No evidence attached yet.", fr: "Aucune preuve rattachée pour l'instant." },
  caseEvidenceDownload: { en: "Download", fr: "Télécharger" },
  caseEvidenceDelete: { en: "Delete", fr: "Supprimer" },
  caseEvidenceDescriptionPlaceholder: { en: "Description (optional)", fr: "Description (facultatif)" },
  caseEvidenceUploadButton: { en: "Upload", fr: "Téléverser" },
  caseEvidenceUploadedToast: { en: "Evidence uploaded.", fr: "Preuve téléversée." },
  caseEvidenceDeletedToast: { en: "Evidence deleted.", fr: "Preuve supprimée." },
  caseEvidenceDeleteDialogTitle: { en: "Delete this evidence?", fr: "Supprimer cette preuve ?" },
  caseEvidenceDeleteDialogDescription: { en: "This cannot be undone.", fr: "Cette action est irréversible." },
  ...
  caseNoteAddedToast: { en: "Note added.", fr: "Note ajoutée." },
  casePriorityUpdatedToast: { en: "Priority updated.", fr: "Priorité mise à jour." },
  caseAssignedToast: { en: "Case assigned.", fr: "Dossier assigné." },
  ...
  kycSessionStartedToast: { en: "Verification session started.", fr: "Session de vérification démarrée." },
  clientsInvitedToast: { en: "Invitation sent.", fr: "Invitation envoyée." },
  clientsInvitationResentToast: { en: "Invitation resent.", fr: "Invitation renvoyée." },
  clientsApprovedToast: { en: "Client approved.", fr: "Client approuvé." },
  clientsRejectedToast: { en: "Client rejected.", fr: "Client rejeté." },
  clientsMoreInfoRequestedToast: { en: "More information requested.", fr: "Informations supplémentaires demandées." },
  alertConfirmedToast: { en: "Alert confirmed.", fr: "Alerte confirmée." },
  alertDismissedToast: { en: "Alert dismissed.", fr: "Alerte rejetée." },
  alertMoreInfoRequestedToast: { en: "More information requested.", fr: "Informations supplémentaires demandées." },
  ...
  ruleEnabledToast: { en: "Rule enabled.", fr: "Règle activée." },
  ruleDisabledToast: { en: "Rule disabled.", fr: "Règle désactivée." },
  sarDraftSavedToast: { en: "Draft saved.", fr: "Brouillon enregistré." },
  sarDraftCreatedToast: { en: "Draft created.", fr: "Brouillon créé." },
  sarSentForReviewToast: { en: "Sent for review.", fr: "Envoyé pour révision." },
  sarApprovedToast: { en: "Report approved.", fr: "Rapport approuvé." },
  sarFiledToast: { en: "Report marked as filed.", fr: "Rapport marqué comme déposé." },
  sarRejectedToast: { en: "Report marked as rejected.", fr: "Rapport marqué comme rejeté." },
  sharedSignalCheckCompleteToast: { en: "Check complete.", fr: "Vérification terminée." },
  pepCreatedToast: { en: "PEP designation created.", fr: "Désignation PPE créée." },
  pepReviewedToast: { en: "PEP designation reviewed.", fr: "Désignation PPE révisée." },
  eddReviewSavedToast: { en: "EDD review saved.", fr: "Vigilance renforcée enregistrée." },
  ctrGeneratedToast: { en: "CTR reports generated.", fr: "Rapports CTR générés." },
  ctrUpdatedToast: { en: "CTR updated.", fr: "CTR mis à jour." },
  ctrFilingNotesRequiredError: { en: "Filing notes are required to proceed.", fr: "Les notes de dépôt sont obligatoires pour continuer." },
  ctrFilingNotesLabel: { en: "Filing notes (required)", fr: "Notes de dépôt (obligatoire)" },
  ctrFilingNotesPlaceholder: {
    en: "e.g. Cash pattern consistent with the customer's declared business, no red flags found.",
    fr: "ex. Schéma d'espèces cohérent avec l'activité déclarée du client, aucun signal d'alerte identifié.",
  },
  ctrReferenceLabel: { en: "Regulator reference (optional)", fr: "Référence du régulateur (facultatif)" },
  ctrConfirmReviewTitle: { en: "Send for MLRO review?", fr: "Envoyer pour examen MLRO ?" },
  ctrConfirmReviewDescription: {
    en: "This moves the report to MLRO review. It stays editable until it's approved.",
    fr: "Ce rapport passe en examen MLRO. Il reste modifiable tant qu'il n'est pas approuvé.",
  },
  ctrConfirmApproveTitle: { en: "Approve for filing?", fr: "Approuver pour dépôt ?" },
  ctrConfirmApproveDescription: {
    en: "This records your MLRO approval and marks the report ready to file with the regulator.",
    fr: "Ceci enregistre votre approbation MLRO et marque le rapport prêt à être déposé auprès du régulateur.",
  },
  ctrConfirmFileTitle: { en: "Record this report as filed?", fr: "Enregistrer ce rapport comme déposé ?" },
  ctrConfirmFileDescription: {
    en: "This is a one-way action — record it once you have actually filed this report with your regulator.",
    fr: "Cette action est irréversible — ne l'enregistrez qu'une fois le rapport réellement déposé auprès de votre régulateur.",
  },
  ctrPreviewButton: { en: "Preview / Export document", fr: "Aperçu / Exporter le document" },
  ctrPreviewBackButton: { en: "← Back to reports", fr: "← Retour aux rapports" },
  ctrDocTitle: { en: "Cash Transaction Report", fr: "Rapport de transaction en espèces" },
  ctrDocDeclaringInstitution: { en: "Declaring institution", fr: "Établissement déclarant" },
  ctrDocCustomer: { en: "Customer", fr: "Client" },
  ctrDocPeriod: { en: "Period", fr: "Période" },
  ctrDocThresholdApplied: { en: "Threshold applied", fr: "Seuil appliqué" },
  ctrDocMlroApprovedAt: { en: "MLRO reviewed at", fr: "Examiné par le MLRO le" },
  teamInvitedToast: { en: "Invitation sent.", fr: "Invitation envoyée." },
  teamInvitationUpdatedToast: { en: "Invitation updated.", fr: "Invitation mise à jour." },
  teamInvitationResentToast: { en: "Invitation resent.", fr: "Invitation renvoyée." },
  teamMemberBlockedToast: { en: "Team member blocked.", fr: "Membre de l'équipe bloqué." },
  teamMemberUnblockedToast: { en: "Team member unblocked.", fr: "Membre de l'équipe débloqué." },
  teamPasswordResetSentToast: { en: "Password reset email sent.", fr: "E-mail de réinitialisation envoyé." },
  roleCreatedToast: { en: "Role created.", fr: "Rôle créé." },
  roleUpdatedToast: { en: "Role updated.", fr: "Rôle mis à jour." },
  roleDeletedToast: { en: "Role deleted.", fr: "Rôle supprimé." },
  apiKeyGeneratedToast: { en: "API key generated.", fr: "Clé API générée." },
  webhookSavedToast: { en: "Webhook saved.", fr: "Webhook enregistré." },
  logoUploadedToast: { en: "Logo updated.", fr: "Logo mis à jour." },
  logoRemovedToast: { en: "Logo removed.", fr: "Logo supprimé." },
  sharedSignalsEnabledToast: { en: "Shared signals enabled.", fr: "Signaux partagés activés." },
  sharedSignalsDisabledToast: { en: "Shared signals disabled.", fr: "Signaux partagés désactivés." },
  passwordUpdatedToast: { en: "Password updated.", fr: "Mot de passe mis à jour." },
  screeningCredentialSavedToast: { en: "Credential saved.", fr: "Identifiants enregistrés." },
  screeningCredentialRemovedToast: { en: "Credential removed.", fr: "Identifiants supprimés." },
  screeningProviderUpdatedToast: { en: "Screening provider updated.", fr: "Fournisseur de filtrage mis à jour." },
  docUploadedToast: { en: "Document uploaded.", fr: "Document téléversé." },
  ...
  sarStatusMlroReview: { en: "MLRO review", fr: "Examen MLRO" },
  sarStatusFilingPending: { en: "Filing pending", fr: "Dépôt en attente" },
  sarStatusFiled: { en: "Filed", fr: "Déposée" },
  sarStatusRejected: { en: "Rejected", fr: "Rejetée" },
  ...
  sarColType: { en: "Type", fr: "Type" },
  sarColRegulatorReference: { en: "Regulator reference", fr: "Référence du régulateur" },
  sarColCase: { en: "Case", fr: "Dossier" },
  sarColTemplate: { en: "Template", fr: "Modèle" },
  sarColSubmitted: { en: "Submitted", fr: "Soumis" },
  sarColUpdated: { en: "Updated", fr: "Mis à jour" },
  ...
  sarNewTypeLabel: { en: "Report type", fr: "Type de déclaration" },
  sarNewCountryHint: {
  ...
  sarRequiredBadge: { en: "Required", fr: "Obligatoire" },
  sarReviewDisabledHint: {
    en: "Fill in the indicators (narrative) above before sending this for review.",
    fr: "Remplissez les indices (narratif) ci-dessus avant d'envoyer ce dossier en revue.",
  },
  sarSaveButton: { en: "Save draft", fr: "Enregistrer le brouillon" },
  sarSubmitButton: { en: "Submit declaration", fr: "Soumettre la déclaration" },
  sarReviewButton: { en: "Send for MLRO review", fr: "Envoyer pour examen MLRO" },
  sarApproveButton: { en: "Approve for filing", fr: "Approuver pour dépôt" },
  sarMarkFiledButton: { en: "Record filed", fr: "Enregistrer le dépôt" },
  sarMarkRejectedButton: { en: "Record rejected", fr: "Enregistrer le rejet" },
  sarReferencePrompt: { en: "Regulator reference (optional)", fr: "Référence du régulateur (facultatif)" },
  sarFilingNotesPrompt: { en: "Filing notes (optional)", fr: "Notes de dépôt (facultatif)" },
  sarConfirmFileTitle: { en: "Record this declaration as filed?", fr: "Enregistrer cette déclaration comme déposée ?" },
  sarConfirmFileDescription: {
    en: "This is a one-way action — record it once you have actually filed this declaration with your regulator.",
    fr: "Cette action est irréversible — ne l'enregistrez qu'une fois la déclaration réellement déposée auprès de votre régulateur.",
  },
  sarConfirmRejectTitle: { en: "Record this declaration as rejected?", fr: "Enregistrer cette déclaration comme rejetée ?" },
  sarConfirmRejectDescription: {
    en: "This closes the declaration without filing it.",
    fr: "Ceci clôture la déclaration sans la déposer.",
  },
  ...
  sarPreviewButton: { en: "Preview / Export document", fr: "Aperçu / Exporter le document" },
  sarPreviewBackButton: { en: "← Back to declaration", fr: "← Retour à la déclaration" },
  sarPreviewPrintButton: { en: "Print / Save as PDF", fr: "Imprimer / Enregistrer en PDF" },
  sarPreviewPrintHint: {
    en: "Use your browser's print dialog and choose \"Save as PDF\" to get a file you can file with your regulator.",
    fr: "Utilisez la boîte de dialogue d'impression de votre navigateur et choisissez « Enregistrer en PDF » pour obtenir un fichier à déposer auprès de votre régulateur.",
  },
  sarDocConfidential: { en: "CONFIDENTIAL — Suspicious Transaction/Activity Report", fr: "CONFIDENTIEL — Déclaration de soupçon" },
  sarDocDeclaringInstitution: { en: "Declaring institution", fr: "Établissement déclarant" },
  sarDocInternalReference: { en: "Internal reference", fr: "Référence interne" },
  sarDocPreparedBy: { en: "Prepared by (user ID)", fr: "Préparé par (ID utilisateur)" },
  sarDocMlroApprovedBy: { en: "MLRO approved by (user ID)", fr: "Approuvé par le MLRO (ID utilisateur)" },
  sarDocReviewedAt: { en: "Reviewed at", fr: "Examiné le" },
  sarDocSubmittedAt: { en: "Submitted at", fr: "Soumis le" },
  sarDocFiledAt: { en: "Filed at", fr: "Déposé le" },
  sarDocFilingNotes: { en: "Filing notes", fr: "Notes de dépôt" },
  sarDocNoValue: { en: "—", fr: "—" },
  sarDocGeneratedOn: { en: "Document generated on", fr: "Document généré le" },
  sarDocSignatureDeclarant: { en: "Signature (MLRO / compliance officer)", fr: "Signature (MLRO / responsable conformité)" },
  sarDocSignatureDate: { en: "Date", fr: "Date" },
  sarDocYes: { en: "Yes", fr: "Oui" },
  sarDocNo: { en: "No", fr: "Non" },

  // ── AML dashboard ─────────────────────────────────────────────────────────
  amlPageTitle: { en: "AML dashboard", fr: "Tableau de bord LBC" },
  amlPageSubtitle: {
    en: "A quick view of the alerts, PEP reviews and SAR/STR work for your organization.",
    fr: "Une vue d'ensemble des alertes, des examens PPE et des déclarations SAR/STR de votre organisation.",
  },
  ...
  amlConfirmedPep: { en: "Confirmed PEP", fr: "PPE confirmées" },
  amlPepReviews: { en: "PEP reviews", fr: "Examens PPE" },
  ...
  sharedSignalColReportId: { en: "Report ID", fr: "ID du rapport" },
  sharedSignalColSourceCase: { en: "Source case", fr: "Dossier source" },
  ...
  auditLogsColType: { en: "Event type", fr: "Type d'événement" },
  auditLogsColId: { en: "Event ID", fr: "ID de l'événement" },
  auditLogsColMetadata: { en: "Metadata fields", fr: "Champs de métadonnées" },
  ...
  securityCurrentPasswordPlaceholder: { en: "••••••••", fr: "••••••••" },
  securityNewPasswordLabel: { en: "New password", fr: "Nouveau mot de passe" },
  securityNewPasswordPlaceholder: { en: "At least 8 characters", fr: "Au moins 8 caractères" },
